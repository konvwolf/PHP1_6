...
if (!empty($productHURL)) {
    $description = getSQLdata(
        PRODUCTS,
        'prod_brand, prod_name, prod_desc, prod_price, '.PHOTOS.'.file_name, '.PHOTOS.'.image_name',
...
<section class="product_description">
    <?php if (!empty($productHURL)): ?>
        ...
        <div class="full_description">
            <h1 class="product_brand"><?= $description[0]['prod_brand'] ?></h1>
            <h2 class="product_descr_name"><?= $description[0]['prod_name'] ?></h2>
            ...
            <span class="product_descr_price"><i class="fas fa-ruble-sign"></i> <?= $description[0]['prod_price'] ?></span>
        </div>
    <?php endif; ?>
